...
## Aim-Confirm Pulse (Engineer, Captain)
...
This matches the approach used by RoR2's built-in AutoPlay bots.
...
|-----------|-----------------|
| Huntress | Can sprint while shooting (most characters can't) |
...
**Directive REPL** — while the brain runs, you can type natural-language goals:
```
